    ...
    <div className="p-4 md:p-10 space-y-8 max-w-[1200px] mx-auto w-full">
      ...
      <footer className="pt-10 pb-6 border-t border-[var(--c-border)]/40 text-center space-y-3">
        <div className="flex flex-wrap items-center justify-center gap-x-5 gap-y-2 text-[12px]">
          ...
          <Link to="/privacy" className="text-[var(--c-muted)] hover:text-[#22D3EE] transition-colors">{t('legal.privacy.title')}</Link>
          <Link to="/terms" className="text-[var(--c-muted)] hover:text-[#22D3EE] transition-colors">{t('legal.terms.title')}</Link>
        </div>
